...
def create_torch_ner_predictions_csv(model, tokenizer, test_dataset, label_list, increment_start, max_length=512, output_file="predictions.csv", device="cuda"):
    """
    ...
    for example in processed_examples:
        ...
        for token_idx, (pred_idx, offset) in enumerate(zip(predictions, offset_mapping)):
            ...
            if current_entity is None:
                ...
                if token_start == 0 or not increment_start:
                    current_entity = {
                        "label": pred_label,
